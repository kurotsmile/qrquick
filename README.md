...
Create QR codes instantly for URLs, text, wifi, and contact info.

## Domain-friendly Name
- Project slug: `qrquick`
- Suggested domain: `qrquick.web.app` or `qrquick.com`
...
3. Initialize project if needed: `firebase use qrquick-nh2672`
